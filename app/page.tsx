...
const timelineEvents = [
  {
    year: "ফেব্রুয়ারি ২০২৬",
    title: "তথ্য ও সম্প্রচার মন্ত্রণালয়ের প্রতিমন্ত্রী",
    desc: "বাংলাদেশ সরকারের তথ্য ও সম্প্রচার মন্ত্রণালয়ের মাননীয় প্রতিমন্ত্রী হিসেবে শপথ গ্রহণ ও দায়িত্ব পালন শুরু।",
    emoji: "🏛️",
    side: "left",
  },
  {
    year: "জানুয়ারি ২০২৬",
    title: "ময়মনসিংহ-৯ আসনে ঐতিহাসিক বিজয়",
    desc: "নান্দাইল উপজেলা (ময়মনসিংহ-৯, ১৫৪ নং আসন) থেকে ৮৫,৭৬১+ ভোট পেয়ে বিএনপি প্রার্থী হিসেবে জাতীয় সংসদে বিজয়ী।",
    emoji: "🗳️",
    side: "right",
  },
  {
    year: "২০২৪",
    title: "বৈষম্যবিরোধী আন্দোলনে সক্রিয় নেতৃত্ব",
    desc: "দেশের জনগণের ন্যায়সঙ্গত দাবি আদায়ে বৈষম্যবিরোধী আন্দোলনে সক্রিয় ভূমিকা পালন।",
    emoji: "✊",
    side: "left",
  },
  {
    year: "২০২২–২৩",
    title: "নান্দাইল উপজেলায় সংগঠন সুদৃঢ়করণ",
    desc: "তৃণমূল পর্যায়ে দলীয় সংগঠন শক্তিশালী করা এবং সেবামূলক কার্যক্রমে অগ্রণী ভূমিকা।",
    emoji: "🌱",
    side: "right",
  },
  {
    year: "২০১৮–২১",
    title: "বিএনপির রাজনৈতিক কার্যক্রমে সক্রিয় অংশগ্রহণ",
    desc: "শহীদ রাষ্ট্রপতি জিয়াউর রহমানের আদর্শে অনুপ্রাণিত হয়ে বিএনপির সাংগঠনিক কার্যক্রমে নিরলস পরিশ্রম।",
    emoji: "🌿",
    side: "left",
  },
];
...
const ministryHighlights = [
  {
    icon: "📡",
    title: "তথ্য অধিকার নিশ্চিতকরণ",
    desc: "জনগণের তথ্য প্রাপ্তির অধিকার সংরক্ষণ এবং সরকারি কার্যক্রমে সর্বোচ্চ স্বচ্ছতা বজায় রাখা।",
  },
  {
    icon: "📰",
    title: "মুক্ত ও স্বাধীন গণমাধ্যম",
    desc: "সাংবাদিকদের কাজের পরিবেশ নিশ্চিত করা এবং স্বাধীন গণমাধ্যমের বিকাশে সহায়তা করা।",
  },
  {
    icon: "🛡️",
    title: "গুজব ও ভুল তথ্য প্রতিরোধ",
    desc: "সামাজিক মাধ্যমে গুজব ও ভুল তথ্য রোধে কার্যকর পদক্ষেপ এবং সচেতনতামূলক প্রচারণা।",
  },
  {
    icon: "🎙️",
    title: "কমিউনিটি রেডিও ও ডিজিটাল মিডিয়া",
    desc: "তৃণমূল পর্যায়ে কমিউনিটি রেডিও সম্প্রসারণ এবং ডিজিটাল মিডিয়ার সুষম ব্যবহার নিশ্চিতকরণ।",
  },
];
    ...
    <>
        ...
        <div className="container hero-wrapper">
          <div className="hero-text-area">
            ...
            <AnimatedHeroText className="">
              <h1 className="leader-name">
                <TypewriterText
                  text="ইয়াসের খান চৌধুরী"
                  highlightWord="চৌধুরী"
            ...
            <FadeInUp delay={0.3}>
              <div className="constituency-tag">
                ...
                নান্দাইল উপজেলা (ময়মনসিংহ-৯, ১৫৪ নং আসন)
              </div>
            </FadeInUp>
            ...
            <FadeInUp delay={0.5}>
              <div className="action-buttons">
                <GlowPulse>
                  <Link href="/vision-2030" className="p-btn p-btn-primary" aria-label="স্মার্ট নান্দাইল ভিশন পৃষ্ঠা দেখুন">
          ...
          <FadeInUp delay={0.2} className="hero-graphic">
          ...
          <StaggerContainer className="metrics-grid" staggerDelay={0.1}>
            <StaggerItem>
              <div className="metric-card">
                ...
                <div className="metric-num" aria-label="Eighty Five Thousand Seven Hundred Sixty One Plus">
                  <AnimatedCounter target={85761} suffix="+" />
                </div>
                <div className="metric-label">ভোটারদের রায়</div>
            ...
            <StaggerItem>
              <div className="metric-card">
                <span className="metric-icon" aria-hidden="true">🏛️</span>
                <div className="metric-num" aria-label="Constituency Mymensingh Nine">১৫৪ নং</div>
                <div className="metric-label">ময়মনসিংহ-৯ (নান্দাইল)</div>
                <div className="metric-desc">নির্বাচনী এলাকার উন্নয়ন ও জনকল্যাণে অঙ্গীকারবদ্ধ</div>
              </div>
            </StaggerItem>
            ...
            <StaggerItem>
              <div className="metric-card">
                ...
                <div className="metric-desc">দেশনায়ক তারেক রহমান ঘোষিত মৌলিক কাঠামোর রূপরেখা</div>
              </div>
            </StaggerItem>
            ...
            <StaggerItem>
              <div className="metric-card">
                <span className="metric-icon" aria-hidden="true">✅</span>
                <div className="metric-num" aria-label="One Hundred Percent Transparency">
      ...
      <section className="about-section" aria-labelledby="about-heading">
        <div className="container about-container">
          <SlideInFromLeft className="about-image-side">
          ...
          <SlideInFromRight className="about-text-side">
            <h4 className="sub-heading">আমার সম্পর্কে</h4>
            <h2 id="about-heading" className="main-heading">
              জনগণের সেবায়, ন্যায়ের <span className="highlight">পথে অবিচল</span>
            </h2>
            ...
            <p className="about-para">
              নান্দাইল উপজেলা (ময়মনসিংহ-৯, ১৫৪ নং আসন)-এর মাটি ও মানুষের সাথে আমার নাড়ির সম্পর্ক। আমার মূল লক্ষ্য হলো তথ্যের অবাধ প্রবাহ নিশ্চিত করা এবং একটি আধুনিক, বৈষম্যহীন ও গণতান্ত্রিক সমাজ বিনির্মাণ করা।
            </p>
            ...
            <ul className="mission-list">
              ...
              <li><span className="check-icon" aria-hidden="true"><i className="fas fa-check"></i></span> তরুণ প্রজন্মের জন্য কর্মসংস্থান ও আইটি খাতের উন্নয়ন।</li>
          ...
          <FadeInUp>
            <div className="minister-welcome-card">
              ...
              <div className="minister-welcome-text">
                <h4 className="sub-heading">মাননীয় প্রতিমন্ত্রীর বার্তা</h4>
                <h2 id="welcome-card-title">তথ্যই শক্তি: অবাধ তথ্য প্রবাহ নিশ্চিত করাই আমাদের অঙ্গীকার</h2>
                <p>
                  তথ্য ও সম্প্রচার মন্ত্রণালয়ের প্রতিমন্ত্রী হিসেবে আমার প্রধান কাজ হলো জনগণের তথ্য অধিকার রক্ষা করা এবং সরকারি কর্মকাণ্ডে স্বচ্ছতা ও জবাবদিহিতা নিশ্চিত করা। শহীদ জিয়ার আদর্শ এবং দেশনায়ক তারেক রহমানের ৩১ দফার আলোকেই আমরা একটি আধুনিক, শোষণমুক্ত এবং আইটি-সমৃদ্ধ নতুন বাংলাদেশ গড়ে তুলবো।
                </p>
                <a
                  ...
                  aria-label="তথ্য ও সম্প্রচার মন্ত্রণালয়ের অফিশিয়াল ওয়েবসাইট ভিজিট করুন (নতুন ট্যাবে খুলবে)"
                >
                  <i className="fas fa-external-link-alt" aria-hidden="true"></i> তথ্য ও সম্প্রচার মন্ত্রণালয় পোর্টাল
                </a>
              </div>
            </div>
          </FadeInUp>
      ...
      <section className="ministry-highlights-section" aria-labelledby="ministry-highlights-title">
        <div className="container">
          <FadeInUp className="section-title">
            <h2 id="ministry-highlights-title" className="title-text">
              মন্ত্রণালয়ের <span className="highlight-green">মূল উদ্যোগ</span>
            </h2>
            <p className="subtitle-text">তথ্য ও সম্প্রচার মন্ত্রণালয়ের অধীনে চলমান গুরুত্বপূর্ণ কার্যক্রম</p>
          </FadeInUp>

          <StaggerContainer className="ministry-grid" staggerDelay={0.12}>
            {ministryHighlights.map((item, index) => (
              <StaggerItem key={index}>
                <div className="ministry-card">
                  <div className="ministry-icon-wrapper" aria-hidden="true">
                    {item.icon}
                  </div>
                  <h3>{item.title}</h3>
                  <p>{item.desc}</p>
      ...
      <section className="action-plan-section" aria-labelledby="action-title">
        <div className="container">
          <FadeInUp className="section-title">
            <h2 id="action-title" className="title-text">
              নান্দাইল গড়বো <span className="highlight-green">নতুন উদ্যমে</span>
            </h2>
            <p className="subtitle-text">জনগণের অধিকার ও সামাজিক নিরাপত্তা নিশ্চিত করাই আমাদের মূল লক্ষ্য।</p>
          </FadeInUp>

          <StaggerContainer className="action-grid" staggerDelay={0.12}>
            <StaggerItem>
              <div className="action-card warning-border">
                <div className="action-icon" aria-hidden="true">🚫</div>
                <h3>জিরো টলারেন্স</h3>
                <p>মাদকের বিরুদ্ধে জিরো টলারেন্স এবং সব ধরনের চাঁদাবাজি ও জুলুম বন্ধে আমরা কঠোর অবস্থানে। নান্দাইল হবে নিরাপদ ও শান্তিময়।</p>
              </div>
            </StaggerItem>
            ...
            <StaggerItem>
              <div className="action-card green-border">
                ...
                <p>আধুনিক মানসম্মত শিক্ষা এবং দোরগোড়ায় স্বাস্থ্যসেবা পৌঁছে দেওয়া। প্রতিটি মানুষের জন্য বিনামূল্যে ঔষধ ও সুচিকিৎসা নিশ্চিত করা।</p>
              </div>
            </StaggerItem>
            ...
            <StaggerItem>
              <div className="action-card green-border">
                <div className="action-icon" aria-hidden="true">🌾</div>
                <h3>কৃষি বিপ্লব</h3>
                <p>আধুনিক প্রযুক্তির সমন্বয়ে কৃষি বিপ্লব ঘটানো। কৃষকদের ন্যায্য মূল্য এবং প্রয়োজনীয় সার ও বীজ সহজলভ্য করা হবে।</p>
              </div>
            </StaggerItem>
            ...
            <StaggerItem>
              <div className="action-card blue-border">
                ...
                <p>কারিগরি শিক্ষা ও আইটি সেক্টরে প্রশিক্ষণের মাধ্যমে বেকার সমস্যার স্থায়ী সমাধান এবং যুবকদের জন্য কর্মসংস্থান সৃষ্টি করা।</p>
              </div>
            </StaggerItem>
          </StaggerContainer>
          ...
          <FadeInUp delay={0.3}>
            <div className="political-slogan-box">
              <h3 className="slogan-white">&quot;মাদক ও চাঁদাবাজমুক্ত নান্দাইল গড়াই <span className="slogan-yellow">আমাদের অঙ্গীকার&quot;</span></h3>
            </div>
          </FadeInUp>
        </div>
      </section>
      ...
      <section className="timeline-section" aria-labelledby="timeline-title">
        <div className="container">
          <FadeInUp className="section-title">
            <h2 id="timeline-title" className="title-text">
              রাজনৈতিক <span className="highlight-green">যাত্রার ইতিহাস</span>
            </h2>
            <p className="subtitle-text">জনসেবার পথে আমার উল্লেখযোগ্য মাইলফলকসমূহ</p>
          </FadeInUp>

          <div className="timeline-track" role="list">
            {timelineEvents.map((event, index) => {
              const isRight = event.side === "right";
              const Card = isRight ? SlideInFromRight : SlideInFromLeft;
              return (
                <div
                  key={index}
      ...
      <section className="updates-section" aria-labelledby="updates-title">
        <div className="container">
          <FadeInUp className="section-title">
            <h2 id="updates-title" className="title-text">
              Recent <span className="highlight-green">Updates</span>
            </h2>
            ...
            {posts.map((post) => (
              <StaggerItem key={post.id}>
                <div className="blog-card">
                  <Link href={`/blog/${post.slug}`} className="blog-thumb-link" aria-label={`${post.title} পোস্ট পড়ুন`}>
                    <Image
                      src={post.image}
                      alt={post.title}
                  ...
                  <div className="blog-body">
                    ...
                    <Link href={`/blog/${post.slug}`} className="read-more-link" aria-label={`${post.title} পোস্ট পড়ুন`}>
                      Read More
                    </Link>
                  </div>
                </div>
          ...
          <div className="center-btn">
            <Link href="/blog" className="p-btn p-btn-primary" aria-label="সকল সংবাদ ও আপডেট দেখুন">
              View More Updates
            </Link>
          </div>
        </div>
      ...
      {/* Journey Gallery Section — Now with Lightbox */}
      <section className="journey-gallery-section" aria-labelledby="gallery-title">
        <div className="container">
          <FadeInUp className="section-title">
            <h2 id="gallery-title" className="title-text">
              আমার <span className="highlight-green">পথচলা</span>
            </h2>
            <p className="subtitle-text">নান্দাইলের মানুষের সাথে কাটানো কিছু স্মৃতিময় মুহূর্ত</p>
          </FadeInUp>

          <GalleryLightbox totalImages={32} />
        </div>
      </section>
      ...
      <section className="portals-section" aria-labelledby="portals-title">
        <div className="container">
          <FadeInUp className="section-title">
            <h2 id="portals-title" className="title-text">
              গুরুত্বপূর্ণ <span className="highlight-green">সরকারি লিঙ্কসমূহ</span>
            </h2>
            <p className="subtitle-text">তথ্য ও সেবার জন্য সরকারি পোর্টালসমূহের তালিকা</p>
          </FadeInUp>

          <StaggerContainer className="portals-list-grid" staggerDelay={0.1}>
            <StaggerItem>
              <div className="portal-dir-card">
                ...
                <div className="portal-details">
                  <h4>তথ্য ও সম্প্রচার মন্ত্রণালয়</h4>
                  <a href="https://moi.gov.bd" target="_blank" rel="noopener noreferrer" aria-label="তথ্য ও সম্প্রচার মন্ত্রণালয় পোর্টাল ভিজিট করুন (নতুন ট্যাবে খুলবে)">moi.gov.bd</a>
                </div>
              </div>
            </StaggerItem>
            ...
            <StaggerItem>
              <div className="portal-dir-card">
                ...
                <div className="portal-details">
                  ...
                  <a href="https://bangladesh.gov.bd" target="_blank" rel="noopener noreferrer" aria-label="বাংলাদেশ জাতীয় তথ্য বাতায়ন ভিজিট করুন">bangladesh.gov.bd</a>
                </div>
              </div>
            </StaggerItem>
            ...
            <StaggerItem>
              <div className="portal-dir-card">
                ...
                <div className="portal-details">
                  ...
                  <a href="https://mopa.gov.bd" target="_blank" rel="noopener noreferrer" aria-label="বাংলাদেশ সচিবালয় পোর্টাল ভিজিট করুন">mopa.gov.bd</a>
                </div>
              </div>
            </StaggerItem>
            ...
            <StaggerItem>
              <div className="portal-dir-card">
                ...
                <div className="portal-details">
                  ...
                  <a href="https://ecs.gov.bd" target="_blank" rel="noopener noreferrer" aria-label="বাংলাদেশ নির্বাচন কমিশন পোর্টাল ভিজিট করুন">ecs.gov.bd</a>
                </div>
              </div>
            </StaggerItem>
          </StaggerContainer>
      ...
      <section className="contact-section" id="contact" aria-labelledby="contact-title">
        <div className="container contact-wrapper">
          <FadeInUp className="contact-info-panel">
            ...
            <div className="contact-card-info">
              <div className="contact-item">
                ...
                <div className="contact-details">
                  <h4>Address</h4>
                  <p>
                    মাননীয় প্রতিমন্ত্রীর কার্যালয়{"\n"}
                    তথ্য ও সম্প্রচার মন্ত্রণালয়{"\n"}
                    বাংলাদেশ সচিবালয়, ঢাকা।{"\n\n"}
                    নির্বাচনী এলাকার কার্যালয়:{"\n"}
                    নান্দাইল উপজেলা বিএনপি কার্যালয়,{"\n"}
                    নান্দাইল, ময়মনসিংহ-১৫৪ নং আসন।
                  </p>
                </div>
              </div>
